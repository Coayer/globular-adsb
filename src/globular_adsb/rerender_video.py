...
def main() -> None:
    parser = argparse.ArgumentParser(description="Re-encode animation videos from existing frames.")
    parser.add_argument("--no-webm", action="store_true", help="Skip VP9/WebM encoding")
    parser.add_argument("--no-h264", action="store_true", help="Skip H.264/MP4 encoding")
